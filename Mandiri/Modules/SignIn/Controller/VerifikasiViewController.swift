...
extension VerifikasiViewController : UITextFieldDelegate {
    func setupTextfield(){
                ...
                if self.thirdText.text != "" {
                    if self.fourthText.text != "" {
                        if self.FiveText.text != "" {
                             SetPinViewController.navigateToModule(self)
                        }
                    }
                }
            }
...
extension VerifikasiViewController {
    static func navigateToModule(_ caller: UIViewController) {
        let sb = UIStoryboard(name:"Signin",bundle: nil)
        let vc = sb.instantiateViewController(withIdentifier: "VerifikasiViewController") as! VerifikasiViewController
